...
static const char* MoniterService_method_names[] = {
  ...
  "/moniter.MoniterService/current_process_moniter_method",
  "/moniter.MoniterService/selected_process_moniter_method",
};
...
MoniterService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_current_process_moniter_method_(MoniterService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_selected_process_moniter_method_(MoniterService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status MoniterService::Stub::current_process_moniter_method(::grpc::ClientContext* context, const ::moniter::ProcessMoniterRequest& request, ::moniter::ProcessMoniterReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::moniter::ProcessMoniterRequest, ::moniter::ProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_current_process_moniter_method_, context, request, response);
}

void MoniterService::Stub::async::current_process_moniter_method(::grpc::ClientContext* context, const ::moniter::ProcessMoniterRequest* request, ::moniter::ProcessMoniterReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::moniter::ProcessMoniterRequest, ::moniter::ProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_current_process_moniter_method_, context, request, response, std::move(f));
}

void MoniterService::Stub::async::current_process_moniter_method(::grpc::ClientContext* context, const ::moniter::ProcessMoniterRequest* request, ::moniter::ProcessMoniterReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_current_process_moniter_method_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::moniter::ProcessMoniterReply>* MoniterService::Stub::PrepareAsynccurrent_process_moniter_methodRaw(::grpc::ClientContext* context, const ::moniter::ProcessMoniterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::moniter::ProcessMoniterReply, ::moniter::ProcessMoniterRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_current_process_moniter_method_, context, request);
}

::grpc::ClientAsyncResponseReader< ::moniter::ProcessMoniterReply>* MoniterService::Stub::Asynccurrent_process_moniter_methodRaw(::grpc::ClientContext* context, const ::moniter::ProcessMoniterRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsynccurrent_process_moniter_methodRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status MoniterService::Stub::selected_process_moniter_method(::grpc::ClientContext* context, const ::moniter::SelectedProcessMoniterRequest& request, ::moniter::SelectedProcessMoniterReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::moniter::SelectedProcessMoniterRequest, ::moniter::SelectedProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_selected_process_moniter_method_, context, request, response);
}

void MoniterService::Stub::async::selected_process_moniter_method(::grpc::ClientContext* context, const ::moniter::SelectedProcessMoniterRequest* request, ::moniter::SelectedProcessMoniterReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::moniter::SelectedProcessMoniterRequest, ::moniter::SelectedProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_selected_process_moniter_method_, context, request, response, std::move(f));
}

void MoniterService::Stub::async::selected_process_moniter_method(::grpc::ClientContext* context, const ::moniter::SelectedProcessMoniterRequest* request, ::moniter::SelectedProcessMoniterReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_selected_process_moniter_method_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::moniter::SelectedProcessMoniterReply>* MoniterService::Stub::PrepareAsyncselected_process_moniter_methodRaw(::grpc::ClientContext* context, const ::moniter::SelectedProcessMoniterRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::moniter::SelectedProcessMoniterReply, ::moniter::SelectedProcessMoniterRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_selected_process_moniter_method_, context, request);
}

::grpc::ClientAsyncResponseReader< ::moniter::SelectedProcessMoniterReply>* MoniterService::Stub::Asyncselected_process_moniter_methodRaw(::grpc::ClientContext* context, const ::moniter::SelectedProcessMoniterRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncselected_process_moniter_methodRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
MoniterService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      MoniterService_method_names[3],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MoniterService::Service, ::moniter::ProcessMoniterRequest, ::moniter::ProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](MoniterService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::moniter::ProcessMoniterRequest* req,
             ::moniter::ProcessMoniterReply* resp) {
               return service->current_process_moniter_method(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      MoniterService_method_names[4],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MoniterService::Service, ::moniter::SelectedProcessMoniterRequest, ::moniter::SelectedProcessMoniterReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](MoniterService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::moniter::SelectedProcessMoniterRequest* req,
             ::moniter::SelectedProcessMoniterReply* resp) {
               return service->selected_process_moniter_method(ctx, req, resp);
             }, this)));
}
...
::grpc::Status MoniterService::Service::current_process_moniter_method(::grpc::ServerContext* context, const ::moniter::ProcessMoniterRequest* request, ::moniter::ProcessMoniterReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status MoniterService::Service::selected_process_moniter_method(::grpc::ServerContext* context, const ::moniter::SelectedProcessMoniterRequest* request, ::moniter::SelectedProcessMoniterReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
